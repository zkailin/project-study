<template>
  <div style="text-align: center;margin: 0 20px">
    ...
    <div style="margin-top: 100px">
      ...
      <div style="font-size: 15px;color: grey">欢迎注册我们的学习平台，请在下方填写相关信息</div>
    </div>

    <div style="margin-top: 50px">
      <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
        <el-form-item prop="username">
          <el-input type="text" :maxlength="8" v-model="form.username" placeholder="用户名">
            <template #prefix>
        ...
        <el-form-item prop="password_repeat">
          <el-input type="password" :maxlength="16" v-model="form.password_repeat" placeholder="重复密码">
            <template #prefix>
              <el-icon><Lock /></el-icon>
            </template>
          </el-input>
